...
const AdminSettings = {
    ...
    ManageThemeLayout() {
        ...
        const verticalLayoutElement =
            document.getElementById("vertical-layout");
        ...
        switch (settings.Direction) {
            case "ltr":
                ...
                const offcanvasStart =
                    document.querySelector(".offcanvas-start");
                if (offcanvasStart) {
    ...
    ManageCardLayout() {
        ...
        const cardWithBorderElement =
            document.getElementById("card-with-border");
        ...
        switch (settings.cardBorder) {
            ...
            case 0:
                ...
                if (cardWithoutBorderElement)
                    cardWithoutBorderElement.checked = true;
                break;
            default:
                break;
        }
