@extends('layout.app')
@push('styles')
    <link rel="stylesheet" href="{{ asset('template/backend') }}/dist/libs/owl.carousel/dist/assets/owl.carousel.min.css">
    ...
    <div class="owl-carousel counter-carousel owl-theme">
            ...
            <div class="card border-0 zoom-in bg-light-primary shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('template/backend') }}/dist/images/svgs/icon-user-male.svg" width="50"
        ...
        <div class="item">
            <div class="card border-0 zoom-in bg-light-warning shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('template/backend') }}/dist/images/svgs/icon-briefcase.svg" width="50"
                            height="50" class="mb-3" alt="" />
        ...
        <div class="item">
            <div class="card border-0 zoom-in bg-light-info shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('template/backend') }}/dist/images/svgs/icon-mailbox.svg" width="50"
                            height="50" class="mb-3" alt="" />
        ...
        <div class="item">
            <div class="card border-0 zoom-in bg-light-danger shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('template/backend') }}/dist/images/svgs/icon-favorites.svg" width="50"
                            height="50" class="mb-3" alt="" />
        ...
        <div class="item">
            <div class="card border-0 zoom-in bg-light-success shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('template/backend') }}/dist/images/svgs/icon-speech-bubble.svg" width="50"
                            height="50" class="mb-3" alt="" />
        ...
        <div class="item">
            <div class="card border-0 zoom-in bg-light-info shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('template/backend') }}/dist/images/svgs/icon-connect.svg" width="50"
                            height="50" class="mb-3" alt="" />
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-7 pb-2">
                        <div class="me-3 pe-1">
                            <img src="{{ asset('template/backend') }}/dist/images/profile/user-1.jpg"
                        ...
                        <ul class="hstack mb-0">
                            <li class="ms-n8">
                                <a href="javascript:void(0)" class="me-1">
                                    <img src="{{ asset('template/backend') }}/dist/images/profile/user-2.jpg"
                            ...
                            <li class="ms-n8">
                                <a href="javascript:void(0)" class="me-1">
                                    <img src="{{ asset('template/backend') }}/dist/images/profile/user-3.jpg"
                                        class="rounded-circle border border-2 border-white" width="44" height="44"
                                        alt="" />
                                </a>
                            </li>
                            <li class="ms-n8">
                                <a href="javascript:void(0)" class="me-1">
                                    <img src="{{ asset('template/backend') }}/dist/images/profile/user-4.jpg"
                                        class="rounded-circle border border-2 border-white" width="44" height="44"
                                        alt="" />
                                </a>
                            </li>
                            <li class="ms-n8">
                                <a href="javascript:void(0)" class="me-1">
                                    <img src="{{ asset('template/backend') }}/dist/images/profile/user-5.jpg"
                                        class="rounded-circle border border-2 border-white" width="44" height="44"
                                        alt="" />
                                </a>
                            </li>
            ...
            <div class="card bg-primary border-0 w-100">
                <div class="card-body pb-0">
                    ...
                    <div class="text-center mt-3">
                        <img src="{{ asset('template/backend') }}/dist/images/backgrounds/piggy.png" class="img-fluid"
                            alt="" />
                    </div>
                </div>
...
@push('scripts')
    ...
    <script src="{{ asset('template/backend') }}/dist/libs/owl.carousel/dist/owl.carousel.min.js"></script>
    <script src="{{ asset('template/backend') }}/dist/libs/apexcharts/dist/apexcharts.min.js"></script>
